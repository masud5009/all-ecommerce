@php
    ...
    $menuItems = [
        ...
        [
            ...
            'route' => 'user.wishlist',
            'icon' =>
                'M20.924 7.924a6 6 0 0 0-8.832-8.832L7.071 5.171A6 6 0 1 0 19 12a1 1 0 1 1 2 0 8 8 0 1 1-2.343-5.657l1.268-1.268a4 4 0 1 0-5.657 5.657l4.243 4.243a2 2 0 1 1-2.828 2.829l-4.243-4.243a1 1 0 0 1 1.414-1.414l4.243 4.243a2 2 0 0 0 2.829-2.828L20.413 12a6 6 0 0 0 .511-4.076z',
        ],
        [
            'name' => 'Edit Profile',
...
<div class="flex h-full flex-col border-r border-slate-200 bg-white">
    ...
    <div class="border-b border-slate-200 px-6 py-4">
        <h2 class="text-lg font-bold text-slate-900">
            {{ Auth::guard('web')->user()->name ?? Auth::guard('web')->user()->username }}
        </h2>
