...
@section('content')
    ...
    <div class="col-lg-12 mb-5">
        ...
        <form id="blogForm" action="{{ route('user.product.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <!--prodct info-->
                <div class="col-lg-9">
                        ...
                        <div class="card-body">
                            <div class="col-lg-12 mx-auto">
                                <div class="language-section">
                                    @include('user.include.languages')
                                    @foreach ($languages as $lang)
                                        <div class="language-content {{ $lang->id == $defaultLang->id ? '' : 'd-none active' }}"
