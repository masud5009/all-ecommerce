        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <div class="col-lg-8">
                        <a href="{{ route('user.product',['language'=>request()->input('language')]) }}" class="btn btn-primary btn-sm float-lg-end float-left">
            ...
            <div class="card-body">
                <div class="col-lg-10 m-auto">
                    ...
                    <form id="blogForm" action="{{ route('user.product.variant_store') }}" method="post">
                        @csrf
