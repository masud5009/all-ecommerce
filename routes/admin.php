    ...
    Route::prefix('product-management')->group(function () {
        ...
        Route::prefix('products')->group(function () {
            ...
            Route::prefix('variants')->group(function () {
                Route::get('/{product_id}', 'Admin\Product\VariantController@index')->name('admin.product.variant');
                Route::post('/store', 'Admin\Product\VariantController@store')->name('admin.product.variant_store');
            });
        });
